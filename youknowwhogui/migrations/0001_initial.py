    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', myghanta.fields.MysqlTimeStampField(auto_now_add=True, null=True)),
                ('updated_at', myghanta.fields.MysqlTimeStampField(auto_now=True, null=True)),
            ],
            options={
